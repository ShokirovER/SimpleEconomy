...
> 🌐 *Примечание: Встроенные интерактивные модели NetLogo не поддерживаются в GitHub Markdown. Вы можете запустить её локально из файла модели.*

### Скачать модель (.nlogo)
[Ссылка на файл модели в репозитории]
...
CSV-файлы с результатами всех прогонов BehaviorSpace: [Ссылка на папку с CSV-файлами]
